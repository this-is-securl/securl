    ...
    return (
      <div className="h-full rounded-[1.8rem] border border-emerald-400/15 bg-slate-950/35 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:p-6">
        ...
        <div className="space-y-4">
          <div className="rounded-[1.2rem] border border-white/10 bg-white/[0.04] px-4 py-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 break-all text-xs leading-5 text-slate-400">{authSession.user.email}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-3 rounded-[1.2rem] border border-white/10 bg-white/[0.04] px-4 py-4 text-xs text-slate-400">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-white/10 bg-white/[0.04] text-slate-100 hover:bg-white/[0.08]"
  ...
  return (
    <div className="h-full rounded-[1.8rem] border border-white/10 bg-slate-950/35 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {mode === "register" ? (
            <Input
              ...
              className="border-white/10 bg-slate-950/45 text-slate-100 placeholder:text-slate-500"
            />
          ) : null}
          <Input
            value={email}
        ...
        <Button
          type="button"
          className="w-full bg-[#b56a2c] text-white hover:bg-[#c2783d]"
