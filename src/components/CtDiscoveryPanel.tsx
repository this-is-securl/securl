      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-[1.25rem] border border-white/10 bg-slate-950/45 p-4">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">Discovered hosts</p>
          ...
          <div className="rounded-[1.25rem] border border-white/10 bg-slate-950/45 p-4">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">Wildcard coverage</p>
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          <div className="rounded-[1.25rem] border border-white/10 bg-slate-950/45 p-4">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">Prioritized hosts</p>
          ...
          <div className="rounded-[1.25rem] border border-white/10 bg-slate-950/45 p-4">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">Sampled coverage</p>
