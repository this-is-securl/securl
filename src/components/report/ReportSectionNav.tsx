                ...
                >
                  <div className="flex items-center gap-3">
                    <Icon
                      className={cn(
                        "h-4 w-4 shrink-0",
                        section.key === activeKey ? "text-[#2dd4bf]" : "text-zinc-500",
                      )}
                    />
                    <div>
                      <p className="text-sm font-semibold text-white">{section.title}</p>
                      {section.badge ? (
                        <p className="mt-0.5 text-[11px] font-medium text-zinc-400">{section.badge}</p>
                      ) : null}
                    </div>
                  </div>
                </SelectItem>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-[#14b8a6]/18 shadow-[0_0_0_1px_rgba(20,184,166,0.3)_inset]"
                      : "hover:bg-white/[0.04]",
                  )}
                >
                  <Icon
                    className={cn(
                      ...
                      active ? "text-[#2dd4bf]" : "text-zinc-600 group-hover:text-zinc-400",
                    )}
                  />
                  <span
                    className={cn(
                      "whitespace-nowrap text-sm transition-colors",
                      active ? "font-bold text-white" : "font-medium text-zinc-400 group-hover:text-zinc-200",
                    )}
                  >
                    {section.title}
                  </span>
